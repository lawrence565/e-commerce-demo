...
function About() {
  return (
    <div className="flex flex-col items-center pb-20">
      ...
      {/* Content Area */}
      <div className="section max-w-[800px] mt-8 space-y-12">
        <h1 className="text-4xl md:text-5xl font-bold font-serif text-ink text-center tracking-wide mb-12">
            關於我們
        </h1>
        <section className="space-y-4">
            <h3 className="text-2xl font-bold font-serif text-clay-deep border-l-4 border-sun pl-4">品牌介紹</h3>
        ...
        <section className="space-y-4">
            <h3 className="text-2xl font-bold font-serif text-clay-deep border-l-4 border-sun pl-4">品牌歷史</h3>
            <p className="text-lg text-ink/80 leading-relaxed">
        ...
        <section className="space-y-4">
            <h3 className="text-2xl font-bold font-serif text-clay-deep border-l-4 border-sun pl-4">品牌理念</h3>
            <p className="text-lg text-ink/80 leading-relaxed">
        ...
        <section className="space-y-4">
            <h3 className="text-2xl font-bold font-serif text-clay-deep border-l-4 border-sun pl-4">品牌目標</h3>
            <p className="text-lg text-ink/80 leading-relaxed">
