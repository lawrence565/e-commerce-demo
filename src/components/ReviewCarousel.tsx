                ...
                <CarouselItem key={index} className="basis-full">
                    <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10 p-4 text-white">
                        ...
                        <div className="text-center md:text-left">
                            <h3 className="text-xl md:text-2xl headline-serif font-bold mb-3">{review.name}</h3>
                            <p className="text-lg md:text-xl leading-relaxed text-white/80 italic">"{review.comment}"</p>
                        </div>
                    </div>
                </CarouselItem>
            ))}
